...
\begin{abstract}
    ...
    \end{enumerate*}
    If \gls{RP} is neglected, the along-track position errors can be as large as 1100 m and the radial error varies periodically with an amplitude of up to 24 m/s, highlighting the importance of adequate force modeling to meet orbit determination requirements.
\end{abstract}
...
\begin{codeav}
The analysis code is available at \url{https://github.com/DominikStiller/tudelft-hpb-project}.
\end{codeav}
