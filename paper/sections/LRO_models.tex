...
\begin{table*}[t]
    ...
    & Moon ellipsoid        & Equatorial radius: \qty{1738.1}{\km}, flattening: 0.0012 &         \\
    & Moon reference frame  & Mean Earth/Polar Axis &                                                  \\
     &                       &  &                                                         \\
    \multicolumn{3}{l}{\textbf{Force models}}                                            \\
     & Moon gravity         & GRGM1200L (truncated to \numproduct{100 x 100}) &                       \\
     & Earth + Sun gravity   & Central     &                                              \\
     & Solar radiation       & Isotropic point source with $L = \qty{3.828e26}{\W}$   & \cref{eq:irradiance-point-luminosity}                     \\
     &                       & Occulted by Moon         &                                    \\
