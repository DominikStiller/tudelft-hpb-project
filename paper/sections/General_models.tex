...
\begin{figure}[t]
    ...
    \caption{Geometry of a \gls{BRDF} for a surface with normal $\vb N$, incoming direction $\vb L$, and observer direction $\vb V$. The viewing angle $\theta_r$ is between $\vb V$ and $\vb N$. Adapted from \cite{Wetterer2014}.}
